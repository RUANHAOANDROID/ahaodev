  ...
  const [posts] = useState<BlogPost[]>([
    {
      ...
      date: '2024-03-01',
      excerpt: '探讨2024年Web开发领域的最新趋势和技术创新...',
      content: `
# 新技术趋势：2024年Web开发展望
...
这些趋势正在塑造Web开发的未来，为开发者和用户alike带来了新的可能性和挑战。持续学习和适应这些新技术将是2024年Web开发者成功的关键。
    ...
    },
    {
      ...
      date: '2024-02-15',
      excerpt: '比较原生和跨平台移动应用开发的优缺点，帮助您做出明智的选择...',
      content: `
# 移动应用开发：原生 vs 跨平台
...
无论选择哪种方法，重要的是要根据项目的具体需求和约束做出明智的决定。
    ...
    },
    {
      ...
      date: '2024-01-30',
      excerpt: '分享10个可以立即提高代码质量和可维护性的最佳实践...',
      content: `
# 提高代码质量的10个最佳实践
...
通过遵循这些最佳实践，开发团队可以显著提高代码质量，减少bug，并提高整体开发效率。记住，编写高质量的代码是一个持续的过程，需要团队的共同努力和承诺。
  ...
  return (
    <div>
      <h1 className="text-3xl font-bold text-gray-800 mb-6">博客</h1>
      <div className="space-y-6">
        {posts.map((post) => (
          <div key={post.id} className="bg-white rounded-lg shadow-md p-6">
            ...
            <Link to={`/blog/${post.id}`} className="text-blue-600 hover:text-blue-800 mt-2 inline-block">
              阅读更多
            </Link>
          </div>
        ))}
